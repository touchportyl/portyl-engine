...
namespace FlexEngine
{
  ...
  namespace glTF
  {
    ...
    /// <para>Adapted from https://fastgltf.readthedocs.io/v0.6.x/overview.html</para>
    /// <para>and vulkan-guide</para>
    /// </summary>
    /// <param name="path">The path to the glTF file</param>
    /// <returns>The glTF data</returns>
    fastgltf::Asset Load(const std::filesystem::path& path)
    {
      // the asset
